...
%  This subscript allows the user to retrieve the DataIndex and the corresponding Time,Displacement,Friction, and Effective Normal Stress data 
%  relative to the three following points necessary for the steady-state analysis using the routine steadystate.m:
...
exp.mu=Mu;      %friction coefficient
...
h=plot(x,y,'-','linewidth',1.5); %Plot friction vs. displacement data relative to the selected velocity step
